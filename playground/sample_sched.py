def Dense_2048x768x2304_sample_sched(sch):
    ...
    # <DietCode>
    # v5, v6, v7, v8, v9 = sch.sample_any_tile(loop=l2, n=5, max_innermost_factor=64,
    ...
    # v15, v16, v17, v18, v19 = sch.sample_any_tile(loop=l3, n=5, max_innermost_factor=64,
    ...
    # v25, v26, v27 = sch.sample_any_tile(loop=l4, n=3, max_innermost_factor=64,
    #                            ^^^      decision=[None, 1, 16])
    #                                               ^^^^ Ditto
    ...
    l59, l60 = sch.split(loop=l58, factors=[None, 256])
    ...
    l66, l67, l68 = sch.split(loop=l65, factors=[None, 256, 3])
