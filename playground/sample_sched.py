def Dense_2048x768x2304_sample_sched(sch):
    ...
    l10, l11, l12, l13, l14 = sch.split(loop=l2, factors=[None, 1, 16, 8, 1])
    l20, l21, l22, l23, l24 = sch.split(loop=l3, factors=[None, 2, 16, 3, 1])
    l28, l29, l30 = sch.split(loop=l4, factors=[None, 1, 16])
